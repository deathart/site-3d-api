...
export class ActionsController {
  ...
  async findById(@Param('id') id: string): Promise<Actions> {
    ...
    @ApiForbiddenResponse({ description: 'Forbidden.'})
    @ApiNotFoundResponse({description: 'Actions or Bank doesnt exist'})
    async findByType(@Param('bankId') bankId: string, @Param('type') type: number): Promise<Actions[]> {
    ...
    @ApiForbiddenResponse({ description: 'Forbidden.'})
    @ApiNotFoundResponse({description: 'Actions or Bank doesnt exist'})
    async findByDate(@Param('bankId') bankId: string, @Param('date') date: Date): Promise<Actions[]> {
    ...
    @ApiForbiddenResponse({ description: 'Forbidden.'})
    @ApiNotFoundResponse({description: 'Action doesnt exist'})
    async updateAction(@Param('id') id: string, @Body() params: UpdateActionDto): Promise<Actions> {
